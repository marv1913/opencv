...
int main(int argc, char** argv)
{
    ...
    if ( rank == 0 ) {
        full_image = cv::imread( "/home/marvin/CLionProjects/mpi_example/kitten.jpeg", cv::IMREAD_UNCHANGED );
    ...
    cv::imwrite( "/home/marvin/CLionProjects/mpi_example/image_slice_" + std::to_string( rank ) + ".jpg", part_image );
